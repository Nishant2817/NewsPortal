 ...
 * Allows sharing articles to social media platforms
 */
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-3">
                ...
                <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-blue-400 hover:bg-blue-500 text-white rounded-lg transition-colors font-medium"
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors font-medium"
                    style={{ minHeight: '44px' }}
                >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
